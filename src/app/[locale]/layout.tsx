...
export async function generateMetadata({ params: { locale } }: Props) {
  return {
    metadataBase: new URL("https://waselalsabreen.vercel.app/"),
    title: {
      template: locale === "ar" ? "%s | واصل" : "%s | WASL",
      default:
        locale === "ar"
          ? "واصل | نقل وتوريد العمالة في مصر"
          : "WASL | Workforce Transportation & Manpower in Egypt",
    },
    description:
      locale === "ar"
    ...
    openGraph: {
      ...
      url: `https://waselalsabreen.vercel.app/${locale}`,
      siteName: "WASL",
      title:
        locale === "ar"
          ? "واصل | نقل وتوريد العمالة في مصر"
