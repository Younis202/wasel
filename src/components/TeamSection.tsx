      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
          {teamMembers.map((member: TeamMember) => (
            <div
              key={member.id}
              className={`group relative p-6 lg:p-8 rounded-3xl bg-black-200 border border-white/[0.1] hover:border-white/[0.2] transition-all duration-500 cursor-pointer h-fit ${
                selectedMember === member.id ? 'border-purple/50 shadow-2xl shadow-purple/10' : ''
              }`}
